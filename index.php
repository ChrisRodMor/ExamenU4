        ...
        <div class="card my-5 mx-3">
          <div class="card-body">
            ...
            <form method="POST" action="auth">
              <div class="mb-3">
                <input type="email" class="form-control" id="floatingInput" placeholder="Email Address" name="correo" />
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" id="floatingInput1" placeholder="Password" name="contrasenna" />
              </div>
